...
type TrafficManagementConfig struct {
	...
	AutoInjection bool `protobuf:"varint,3,opt,name=autoInjection,proto3" json:"autoInjection,omitempty"`
...
type PilotConfig struct {
	...
	TraceSampling float32 `protobuf:"fixed32,3,opt,name=traceSampling,proto3" json:"traceSampling,omitempty"`
...
type ProxyConfig struct {
	...
	EnableCoredump   bool                         `protobuf:"varint,3,opt,name=enableCoredump,proto3" json:"enableCoredump,omitempty"`
	...
	IncludeIPRanges     string `protobuf:"bytes,8,opt,name=includeIPRanges,proto3" json:"includeIPRanges,omitempty"`
	ExcludeIPRanges     string `protobuf:"bytes,9,opt,name=excludeIPRanges,proto3" json:"excludeIPRanges,omitempty"`
	IncludeInboundPorts string `protobuf:"bytes,10,opt,name=includeInboundPorts,proto3" json:"includeInboundPorts,omitempty"`
	ExcludeInboundPorts string `protobuf:"bytes,11,opt,name=excludeInboundPorts,proto3" json:"excludeInboundPorts,omitempty"`
	...
	PodDNSSearchNamespaces string `protobuf:"bytes,17,opt,name=podDNSSearchNamespaces,proto3" json:"podDNSSearchNamespaces,omitempty"`
	// Tracer options
	...
	ReadinessProbe *v1.Probe                `protobuf:"bytes,50,opt,name=readinessProbe,proto3" json:"readinessProbe,omitempty"`
...
type IstioInstaller struct {
	Spec                 *InstallerSpec   `protobuf:"bytes,1,opt,name=spec,proto3" json:"spec,omitempty"`
	Status               *InstallerStatus `protobuf:"bytes,2,opt,name=status,proto3" json:"status,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
type SdsConfig struct {
	...
	UseTrustworthyJwt    bool     `protobuf:"varint,3,opt,name=useTrustworthyJwt,proto3" json:"useTrustworthyJwt,omitempty"`
	UseNormalJwt         bool     `protobuf:"varint,4,opt,name=useNormalJwt,proto3" json:"useNormalJwt,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
var fileDescriptor_d0a1188b3d395975 = []byte{
	...
	,
}
