...
gen_patch:
	diff -u pkg/apis/installer/v1alpha1/istioinstaller_types.pb.go.orig pkg/apis/installer/v1alpha1/istioinstaller_types.pb.go > pkg/apis/installer/v1alpha1/fixup_go_structs.patch
