...
proto:
	...
	go run ~/go/src/k8s.io/code-generator/cmd/deepcopy-gen/main.go -O zz_generated.deepcopy -i ./pkg/apis/installer/v1alpha1/... -i ./vendor/github.com/gogo/protobuf/types/...
